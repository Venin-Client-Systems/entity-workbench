...
def main():
    ...
    command = ["cargo", "test", "--locked", "-p", "workbench-core", "--lib", "engines::", "--", "--include-ignored", "--skip", "engines::ocr::", "--skip", "engines::supervision::ocr::", "--skip", "engines::image::", "--skip", "engines::supervision::image_tests::", "--test-threads=1", "--nocapture"]
