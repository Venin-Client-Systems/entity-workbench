...
def main():
    ...
    command = ["cargo", "test", "--locked", "-p", "workbench-core", "--lib", "engines::", "--", "--include-ignored", "--skip", "engines::parser::windows::", "--skip", "engines::ocr::", "--skip", "engines::ocr_regions::", "--skip", "engines::supervision::ocr::", "--skip", "engines::image::", "--skip", "engines::supervision::image_tests::", "--skip", "engines::pdf_render::", "--skip", "engines::supervision::pdf_tests::", "--test-threads=1", "--nocapture"]
