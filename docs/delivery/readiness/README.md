...
A missed date is reported separately as **overdue**. It does not change evidence or status automatically. Reconfirm reservations and signing access before each later checkpoint; expired/revoked access must be updated rather than carried forward as still confirmed.
