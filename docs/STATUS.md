...
|---|---|---|
| Product design | Native editable Figma frames for industrial transactions, statement mapping, findings and collection receipts/exceptions; graphite/amber palette, joined instruments, square controls, bundled Inter/JetBrains Mono; desktop/compact exported comparisons, axe and keyboard checks | Document-job and remaining workflow frames, long-content refinement, icon review, manual accessibility and final visual sign-off |
...
| Evidence | Retained originals, UTF-8 text/CSV/TSV import, hash deduplication, source rows, escaped review; confined Mac development extraction of TXT/PDF/DOCX into bounded immutable unreviewed derivatives | OCR and page/cell regions; complex tables; remaining Office/image/email formats; derivative review/acceptance UI; installed-runtime integration |
| Document jobs | Rust-owned durable queue, reserved attempt identities, bounded manual retry, cancellation, explicit desktop shutdown, exclusive coordinator ownership, atomic derivative publication, interrupted recovery and backup/restore | Designed job/derivative controls; collection/OCR/analysis integration, pagination/recipes, supervisor-crash process recovery and Windows runtime integration |
